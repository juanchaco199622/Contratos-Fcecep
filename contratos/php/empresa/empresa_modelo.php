    ...
    public function listaCiudad() {
      ...
      return $this->rows;
		...
		public function lista() {
			$this->query = "
			SELECT id_empresa, nombre_empresa, nit_empresa, sector_empresa, c.nombre_ciudad
      FROM `tb_empresa` as e INNER JOIN tb_ciudad as c ON (e.id_ciudad = c.id_ciudad)
      ORDER BY id_empresa ";
			$this->obtener_resultados_query();
			return $this->rows;
		}
      ...
      if(array_key_exists('id_empresa', $datos)):
        ...
        endforeach;
        $this->query = "
        INSERT INTO `tb_empresa`(`id_empresa`, `nombre_empresa`, `nit_empresa`, `id_ciudad`, `sector_empresa`)
        VALUES (null,'$nombre_empresa','$nit_empresa','$id_ciudad','$sector_empresa')";
