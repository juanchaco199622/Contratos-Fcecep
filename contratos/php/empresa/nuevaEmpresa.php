...
$empresa = new Empresa();
$listaciudad =  $empresa->listaCiudad();
		  	...
		  	<div class="panel-heading">Datos de la Empresa</div>
					...
					<form class="form-horizontal" role="form"  id="fempresa">
					              ...
					              <label class="control-label col-sm-2" for="id_empresa">ID:</label>
					                <div class="col-sm-10">
					                    <input type="text" class="form-control" id="id_empresa" name="id_empresa" placeholder="Ingrese Codigo" value = "" readonly="true"  data-validation="length alphanumeric" data-validation-length="3-12">
					                </div>
					          </div>
			              ...
			              <div class="col-sm-10">
			                  <input type="text" class="form-control" id="nombre_empresa" name="nombre_empresa" placeholder="Ingrese Nombre Empresa"
			                    ...
			                    <div class="form-group">
			                        ...
			                        <div class="col-sm-10">
			                            <input type="text" class="form-control" id="sector_empresa" name="sector_empresa" placeholder="Ingrese Sector" value = "">
			                        </div>
			                    </div>
			                  ...
			                  <div class="col-sm-offset-2 col-sm-10">
			                      ...
			                      <button type="button" id="cerrar" class="btn btn-success btncerrarEmpresa2" data-toggle="tooltip" title="Cancelar">Cancelar</button>
			                  </div>
								</div>
