...
<div class="box-header">
    ...
    <div class="pull-right box-tools">
    	<button class="btn btn-info btn-sm" id="nuevaEmpresa"  data-toggle="tooltip" title="Nueva Empresa"><i class="fa fa-plus" aria-hidden="true"></i></button>
    	<button class="btn btn-info btn-sm btncerrarEmpresa"  data-toggle="tooltip" title="Ocultar"><i class="fa fa-times"></i></button>
