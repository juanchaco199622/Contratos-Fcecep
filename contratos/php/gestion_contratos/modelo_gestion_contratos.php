...
class Contratos extends ModeloAbstractoDB {
	...
	public function consultar($id_contrato='') {
			...
			if($id_contrato !=''):
				$this->query = "
				SELECT id_contrato, nombre_contrato, fecha_inicio_contrato, fecha_fin_contrato , descripcion_contrato, id_proveedor, nombre_proveedor,id_empresa
				FROM tb_contrato
		...
		public function lista() {
			...
			INNER JOIN tb_empresa AS e ON(C.id_empresa = e.id_empresa)
		...
		public function nuevo($datos=array()) {
			...
			if(array_key_exists('id_contrato', $datos)):
				...
				$this->query = "
					...
					(id_contrato, nombre_contrato ,fecha_inicio_contrato, fecha_fin_contrato, descripcion_contrato, id_proveedor, nombre_proveedor,id_empresa)
					VALUES
					(NULL, '$nombre_contrato', '$fecha_inicio_contrato', '$fecha_fin_contrato', '$descripcion_contrato', '$id_proveedor', '$nombre_proveedor','$id_empresa')";
