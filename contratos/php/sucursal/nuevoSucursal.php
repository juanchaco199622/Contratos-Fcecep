												...
												<label class="control-label col-sm-2" for="id_ciudad">Ciudad:</label>
													<div class="col-sm-10">
																	<select class="form-control" id="id_ciudad" name="id_ciudad">
																					<option value="" selected>Seleccione la ciudad de la sucursal...</option>
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <button type="button" id="cerrar" class="btn btn-success btncerrarSucursal2" data-toggle="tooltip" title="Cancelar">Cancelar</button>
                        </div>
                    </div>
