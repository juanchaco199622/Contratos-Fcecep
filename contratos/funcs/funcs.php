<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Host = 'smtp.gmail.com'; //medio de seguridad por el cual se va enviar
	...
	function login($usuario, $password)
	{
		global $mysqli;
				...
				$stmt = $mysqli->prepare("
				SELECT
				 					u.id, u.id_tipo,u.password,
									t.pais_permiso, t.proveedor_permiso, t.sucursal_permiso, t.ciudad_permiso,
									t.empresa_permiso, t.contrato_permiso, t.empleado_permiso, t.roles_permiso,
									t.informe_permiso, t.procesos_permiso,t.usuario_permiso
				FROM
									usuarios AS u
				INNER JOIN
		...
		if($rows > 0) {
					if(isActivo($usuario)){
								...
								$pais_permiso,$ciudad_permiso,$proveedor_permiso, $sucursal_permiso,$empresa_permiso,
								$contrato_permiso,$empleado_permiso,$roles_permiso,$informe_permiso,$procesos_permiso,$usuario_permiso);
								$stmt->fetch();
								...
								if($validaPassw){
									...
									$_SESSION['pais_permiso'] = $pais_permiso;
									$_SESSION['ciudad_permiso'] = $ciudad_permiso;
									$_SESSION['proveedor_permiso'] = $proveedor_permiso;
									$_SESSION['empresa_permiso'] = $empresa_permiso;
									$_SESSION['contrato_permiso'] = $contrato_permiso;
									$_SESSION['empleado_permiso'] = $empleado_permiso;
									$_SESSION['sucursal_permiso'] = $sucursal_permiso;
									$_SESSION['roles_permiso'] = $roles_permiso;
									$_SESSION['informe_permiso'] = $informe_permiso;
									$_SESSION['procesos_permiso'] = $procesos_permiso;
									$_SESSION['usuario_permiso'] = $usuario_permiso;
